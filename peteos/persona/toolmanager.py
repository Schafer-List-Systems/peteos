...
def _wrap_for_runner(fn: Callable) -> Callable:
    """Wrap fn so it accepts runner=None without error.

    If fn already accepts a 'runner' parameter, return it unchanged.
    Otherwise, wrap it in a helper that strips 'runner' from kwargs
    ...
    if 'runner' in sig.parameters:
        return fn  # already accepts runner
...
class Tool:
    ...
    def __init__(
        ...
        self._func = _wrap_for_runner(func)
    ...
    def _extract_parameters(func: Callable) -> dict:
        ...
        Excludes 'runner' parameter since it's provided by the
