"""SandboxBuilder - declarative sandbox construction with chained scopes."""
...
class SandboxBuilder:
    """Declarative sandbox construction with chained scopes.

    Each SandboxBuilder contributes one scope layer to the final Sandbox.
    Scopes are chained via the ``base`` parameter (parent builder).
    """
